...
use $data/furniture_decomposition_q_dyn.dta, clear
...
drop type 
ren line_ im_line
export delimited "../../data_for_paper/data_decomp_line_for_R.csv", replace
restore 
...
export delimited "../../data_for_paper/data_decomp_for_R.csv", replace
